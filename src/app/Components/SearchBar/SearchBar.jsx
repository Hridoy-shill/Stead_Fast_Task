...
const SearchBar = () => {
  ...
  return (
    <div className="flex flex-wrap md:flex-nowrap justify-between items-center bg-[#0f172a] text-white px-5 md:px-[50px] py-4 md:py-[20px] gap-4 md:gap-0">
      <Link href={"/"} className="flex gap-2 items-center flex-shrink-0">
        <Image src={falconIcon} alt="Falcon Icon" width={24} height={24} />
        <div className="text-2xl md:text-[28px] font-semibold text-white">FALCON</div>
      </Link>
